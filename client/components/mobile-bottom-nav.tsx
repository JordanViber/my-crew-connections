...
export function MobileBottomNav() {
  ...
  return (
    <nav className="fixed inset-x-2 bottom-2 z-40 md:hidden">
      <div className="glass-panel mx-auto grid max-w-72 grid-cols-3 border border-border/80 px-1.5 py-1.5 shadow-[0_12px_28px_rgba(31,44,49,0.14)] backdrop-blur-xl">
        {items.map((item) => {
